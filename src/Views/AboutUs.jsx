const AboutUs=()=>{
    return(
    <section class="text-black body-font bg-purple-500 overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Pricing</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-black">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical.</p>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                ...
                <p class="flex items-center text-gray-600 mb-6">
                    ...
                    </span>Mix tape chill wave tumeric
                </p>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                <div class="h-full p-6 rounded-lg border-2 border-indigo-500  bg-white flex flex-col relative overflow-hidden">
